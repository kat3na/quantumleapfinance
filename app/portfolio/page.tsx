...
const router = useRouter();
  ...
  const activeTrades = [
    { asset: 'BTC/USD', type: 'Buy', amount: '$1,000', pnl: '+$120' },
    { asset: 'AAPL', type: 'Sell', amount: '$500', pnl: '-$40' }
  ];

  const tradeHistory = [
    { asset: 'ETH/USD', type: 'Buy', result: 'Win', pnl: '+$90' },
    { asset: 'GOOG', type: 'Sell', result: 'Loss', pnl: '-$60' },
    { asset: 'EUR/USD', type: 'Buy', result: 'Win', pnl: '+$40' }
  ];
